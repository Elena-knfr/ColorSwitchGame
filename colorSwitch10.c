...
//int y_color_change_ball [NUM_OBSTACLES] = {-20, -185, -320};
			...
			if (RVALID){
				...
				if (byte2 == 0x29 && byte1 != 0xF0) { // if space is pressed
					...
					while(!game_over) {
						...
						//draw_color_change_ball (y_color_change_ball, r_color_change_ball);
						...
						/*if (y_player - r_player < y_color_change_ball[(closest_obstacle_i+2)%NUM_OBSTACLES] + r_color_change_ball){
							color_player = RED;
							y_color_change_ball[(closest_obstacle_i+2)%NUM_OBSTACLES] = y_obstacle[closest_obstacle_i] - r_obstacle[closest_obstacle_i] -20;
								//y_color_change_ball[(closest_obstacle_i+1)%NUM_OBSTACLES] - 150;
						}*/
...
void reset_game () {
	...
	//y_color_change_ball [NUM_OBSTACLES] = {125, -25, -175};
